...
//Pointer lock controls reference - https://threejs.org/docs/#examples/en/controls/PointerLockControls 

//NOTE: CHANGE PLACEHOLDER CONTROLS
export const controls = (function() {
  return {
    //FPS style controls from official three js example 
    //Collision and movement from tutorial - https://www.youtube.com/watch?v=hHGshzIXFWY&list=PLRL3Z3lpLmH3PNGZuDNf2WXnLTHpN9hXy
